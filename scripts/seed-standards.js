...
async function seedStandards() {
  try {
    ...
    // Display inserted standards
    const insertedStandards = await Standard.find({});
    console.log('Inserted standards:');
    insertedStandards.forEach(standard => {
      console.log(`- ${standard.name} (${standard.code})`);
    });
